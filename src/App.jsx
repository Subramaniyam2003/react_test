    ...
    <div>
       <nav className="flex justify-between items-center p-2 font-semibold text-3xl flex-wrap bg-lime-500" id="nav_full">
          ...
          <div>
            ...
            <li className="mr-8"><Link to="/react_test/">Home</Link></li>
            <li className="mr-8"><Link to="/react_test/about">About Me</Link></li>
            <li className="mr-8"><Link to="/react_test/portfolio">Portfolio</Link></li>
            <li><Link to ="/react_test/contact">Contact Me</Link></li>
            </ul>
          </div>
        </nav>
      <Routes>
